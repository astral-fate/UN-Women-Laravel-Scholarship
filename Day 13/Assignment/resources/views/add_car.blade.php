      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('cars.store')}}" method="POST" class="px-md-5" enctype="multipart/form-data">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" id="carTitle" placeholder="BMW" class="form-control py-2" name="carTitle" value="{{old('carTitle')}}" />
              @error('carTitle')
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" id="price" step="0.01" placeholder="Enter price" class="form-control py-2" name="price" value="{{old('price')}}" />
              @error('price')
                <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <textarea id="description" cols="30" rows="5" class="form-control py-2" name="description">{{old('description')}}</textarea>
              @error('description')
                <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
