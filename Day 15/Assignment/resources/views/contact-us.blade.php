        ...
        <div class="py-5 px-md-5 px-1  rounded-1 mx-md-5" style="background-color: #fffffff2;">
            ...
            <form action="{{ route('contact.submit') }}" method="POST">
                ...
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-md-10">
                        <input type="email" name="email" id="email" placeholder="e.g. example@example.com" class="form-control py-2" required />
                    </div>
                </div>
                <div class="form-group mb-3 row">
                    <label for="subject" class="form-label col-md-2 fw-bold text-md-end">Subject:</label>
                    <div class="col-md-10">
                        <input type="text" name="subject" id="subject" placeholder="Enter subject" class="form-control py-2" required />
                    </div>
                </div>
                <hr>
                <div class="form-group mb-3 row">
                    ...
                    <div class="col-12">
                        <textarea name="message" id="message" class="form-control" rows="8" style="padding: 0.7rem;" required></textarea>
                    </div>
                </div>
                <div class="mb-3">
