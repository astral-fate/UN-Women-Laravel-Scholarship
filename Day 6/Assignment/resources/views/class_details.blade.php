          ...
          <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              <div class="mb-4 text-center py-2">
                <h2 class="fw-bold bg-light card-header">{{$class['carTitle']}}</h2>
              </div>
              <div class="mb-4">
                <p class="card-text">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Published:</span> {{ $class->published ? 'Yes' : 'No' }}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Description:</span><br>{{$class['description']}}
                </p>
              </div>
              <div class="text-md-end">
              
                <a href="{{route('class.index')}}" class="btn mt-4 btn-primary text-white fs-5 fw-bold border-0 py-2 px-md-5">
                  Back to All classes
                </a>
              </div>
            </div>
